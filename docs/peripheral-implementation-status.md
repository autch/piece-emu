...
**最終更新**: 2026-04-13  
**対象ディレクトリ**: `src/core/`, `src/soc/`, `src/debug/`  
...
```
[==========] 149 tests from 11 test suites ran.
[  PASSED  ] 149 tests.
```
...
実装ファイル: `src/host/lcd_renderer.cpp`, `src/host/audio_out.cpp`, `src/host/input_handler.cpp` (未作成)

参考: `piemu/lcdc.c`（2bitピクセル→SDL2 Surface変換、SDL3 Texture に読み替えること）  
